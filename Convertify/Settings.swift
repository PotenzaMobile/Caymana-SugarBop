...
class Settings {
    ...
    public static let HOST = "sugarbop.com" /// if url has "www" then add host like "www.domain.com" else would be white screen
    
    public static let URL = "https://sugarbop.com/"
